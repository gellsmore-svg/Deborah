...
PLAN plan_answer_substrate_question REVISION 1 [STATUS: draft]
  ...
  PROCESS AnswerSubstrateQuestion (INPUT: question; OUTPUT: verdict_or_open)
    1. STEP — Retrieve corpus material that bears on the claim. [CODE, DETERMINISTIC]
    ...
    2. STEP — Form a provisional reading given the evidence. [LLM, STOCHASTIC]
    ...
    4. DECISION — Commit or leave open. [HUMAN, ASSISTED-BY: LLM, GATED]
       ...
       CONSTRAINTS: if evidence is empty or critique underspecified, prefer open.
```
